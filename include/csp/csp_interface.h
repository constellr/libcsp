...
#define CSP_IFLIST_NAME_MAX 10
   ...
   */
   ...
   // typedef int (*nexthop_t_udp)(csp_iface_t * iface, uint16_t via, csp_packet_t * packet, int from_me);
   ...
   */
   ...
   struct csp_iface_s
   {
      uint16_t addr;             // Host address on this subnet -udp
      uint16_t netmask;          // Subnet mask - udp
